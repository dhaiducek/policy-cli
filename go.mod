...
require (
	...
	github.com/stolostron/go-template-utils/v6 v6.5.1-0.20250408132527-b4db28d109a0
	open-cluster-management.io/config-policy-controller v0.16.1-0.20250407210744-53437fb4325e
)
